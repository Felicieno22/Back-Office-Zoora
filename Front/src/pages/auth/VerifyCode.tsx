...
import { Film, ShieldCheck, ArrowLeft } from 'lucide-react';
...
export function VerifyCode({ onSwitchToLogin }: VerifyCodeProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response?.message) {
        ...
        localStorage.removeItem('verification_source');
      ...
      <div className="w-full max-w-md">
        <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-800 p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl text-white mb-2">Vérification</h1>
